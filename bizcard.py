...
mydb = pymysql.connect(host = '127.0.0.1',user='root',passwd='Jeya@123',database = "bizcard")
...
if selected == "Home":
        ...
        image = Image.open(r"C:\Users\91978\Downloads\business-card-data-extraction.jpg") 
